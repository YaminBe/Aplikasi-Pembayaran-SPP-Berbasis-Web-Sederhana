...
<div id="page-wrapper">
			<div class="main-page">
				<h3 class="title1">  <span class="fa fa-folder-o"></span> Kas Siswa <small>/ Kas Masuk</small> </h3>
...
<h3><span class="fa fa-folder-o"></span> Daftar Kas Masuk</h3>
</div>
...
<table class="table table-striped table-bordered table-hover data">
    ...
    <tbody>
        ...
        <?php 
            ...
            $no = 1;
            $total=0;
            $sql = $konek->query("select * from db_kas where jenis = 'masuk' ");
