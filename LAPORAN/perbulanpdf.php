...
<h3 align="center">
	...
	<p>
		Bulan :<?php echo $_GET['bulan']." - ". $_GET['kelas']; ?>
	</p>
...
$sql_Bayar = mysqli_query($konek, "SELECT spp.*,siswa.nis,siswa.namasiswa,siswa.kelas
 ...
 WHERE bulan='$_GET[bulan]' AND kelas='$_GET[kelas]'") or die(mysqli_error($konek)) ;
...
?>
							<tr>
								...
								<td><?php if ($d['ket']=='LUNAS') {
									echo "<b>LUNAS</b>";
								}else{ echo "Belum Bayar";} ?> </td>
							</tr>
							<?php 
							$total +=$d['jumlah'];
							 ...
							 ?>
							 <tr>
							 	<td colspan="5" align="right"> Jumlah Total </td>
