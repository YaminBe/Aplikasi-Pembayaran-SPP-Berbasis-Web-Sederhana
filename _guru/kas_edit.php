...
<!-- 	<div class="form-group">
		...
		<option value="<?php echo $d['namasiswa']; ?>" selected><?php echo $d['namasiswa']; ?></option>
		<?php
		$sqlKelas = mysqli_query($konek, "select * from siswa");
		while($k=mysqli_fetch_array($sqlKelas)){
		?>
		<option value=""><?php echo $k['namasiswa']; ?></option>
		<?php
		}
		?>
		</select>		
...
<!-- 	<div class="form-group">
	...
	<div class="form-group">
		<button type="submit" name="update_kas" class="btn btn-success"> <span class="fa fa-edit"></span> Edit </button>
