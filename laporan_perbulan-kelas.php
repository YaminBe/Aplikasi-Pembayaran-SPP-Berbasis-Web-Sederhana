...
<div id="page-wrapper">
			<div class="main-page">
					<h3 class="title1">  <span class="fa fa-print"></span> Laporan <small>/ Laporan Bulan & Kelas</small> </h3>
<hr style="border: 1px solid #f50057;">
				<div class="blank-page widget-shadow scroll" id="style-2 div1">
					<strong><span class="fa fa-file"></span> LAPORAN PEMBAYARAN SPP ,BULAN,KELAS, BULAN & KELAS</strong>
					<hr>
<div class="col-md-3">
...
<!-- 
<a target="_blank" href="LAPORAN/perbulanpdf-1.php?bulan=<?php echo $_GET['bulan'];?>" class="btn btn-default"> <span class="fa fa-print"></span> Cetak Perbulan </a>

<a target="_blank" href="LAPORAN/perkelaspdf.php?kelas=<?php echo $_GET['kelas'];?> " class="btn btn-default"> <span class="fa fa-print"></span> Cetak Perkelas </a> -->

<a target="_blank" href="LAPORAN/perbulanpdf.php?bulan=<?php echo $_GET['bulan'];?>&kelas=<?php echo $_GET['kelas'];?> " class="btn btn-warning"> <span class="fa fa-print"></span> Perbulan & Kelas Cetak PDF </a>
	 <hr>
...
$no=1;
$total=0;
$sql_Bayar = mysqli_query($konek, "SELECT * FROM spp

 INNER JOIN siswa ON spp.idsiswa=siswa.idsiswa
 WHERE spp.bulan='$_GET[bulan]' AND siswa.kelas='$_GET[kelas]'") or die(mysqli_error($konek)) ;
